...
tinyMCE.init({
    ...
    theme_advanced_buttons1: "formatselect,bold,italic,underline,bullist,numlist,blockquote,code,undo,redo,link,unlink,image,code,fullscreen,pasteword,media,charmap",
